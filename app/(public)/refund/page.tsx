...
import { REFUND_SECTIONS, LAST_UPDATED, POLICY_CONTACT_EMAIL } from "@/lib/legal/policies"

export const metadata: Metadata = {
  title: "Return and Refund Policy",
  description: "Return and Refund Policy for Planet-Concord products offered through Whop.",
  openGraph: {
    title: "Return and Refund Policy | Planet-Concord",
    description: "Return and Refund Policy for Planet-Concord products offered through Whop.",
