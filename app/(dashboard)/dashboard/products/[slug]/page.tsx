  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-6xl">
      <div className="space-y-8">
        ...
        {isActive && product.discordInviteUrl && (
          <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 backdrop-blur-xl p-6">
            <div className="absolute inset-0 bg-linear-to-br from-[#5865F2]/10 via-transparent to-[#5865F2]/5" />
            <div className="relative flex items-start justify-between gap-4">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-lg bg-[#5865F2]/10 shrink-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Connect with other members, get support, and stay updated with the latest tips and resources.
                  </p>
                </div>
              </div>
              <a
                ...
                className="shrink-0 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#5865F2] text-white text-sm font-semibold hover:bg-[#4752C4] transition-colors duration-200"
              >
